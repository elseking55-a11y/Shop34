        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 lg:py-48">
          ...
          >
            {siteSettings.heroBadge && (
              <div className="inline-flex items-center gap-2 text-orange-200" style={{ backgroundColor: "color-mix(in srgb, var(--shop-accent) 30%, transparent)", borderColor: "color-mix(in srgb, var(--shop-accent) 50%, transparent)" }} text-[11px] sm:text-xs font-bold px-3 py-1 sm:px-4 sm:py-1.5 rounded-full border border-orange-500/30 uppercase tracking-wider mb-5">
