          ...
          >
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <Link 
                ...
                className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-500 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-bold text-sm sm:text-lg transition-all hover:gap-4 hover:shadow-lg hover:shadow-orange-900/20"
              >
